...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2025 a las 19:51:29
...
(33, 'carolinagomez1232006@gmail.com', '9b8769a4a742959a2d0298c36fb70623f2dfacda8436237df08d8dfd5b37374c', 2, 1),
...
--
ALTER TABLE `historial_cancelaciones`
  MODIFY `id_cancelacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `historial_modificaciones`
--
ALTER TABLE `historial_modificaciones`
  MODIFY `id_modificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `horarios_profesionales`
--
ALTER TABLE `horarios_profesionales`
  MODIFY `id_horario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1087;
